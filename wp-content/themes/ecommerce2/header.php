...
<head>
    ...
    <img src="<?php echo get_bloginfo('template_directory') ?>/imag/logo.gif" style="width:100%"  alt="">
</head>
    <body> 
<div class="container">
<!-- Header -->
...
<nav class="navbar navbar-light bg-light">
    ...
    <a href="http://localhost:81/merkado/wordpress/"><img src="<?php echo get_bloginfo('template_directory') ?>/image/1.png"alt="" width="30%" height="30%"></a>
    </a>
</nav>
<select id="cars">
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo get_bloginfo('template_directory') ?>/image/3.jpg" style="width:100%;height: 350px;" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo get_bloginfo('template_directory') ?>/image/4.jpeg" style="width:100%;height: 350px;" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo get_bloginfo('template_directory') ?>/image/5.jpg" style="width:100%;height: 350px;" class="d-block w-100" alt="...">
    </div>
  </div>
